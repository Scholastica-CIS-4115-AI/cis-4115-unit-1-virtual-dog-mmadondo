...
public class dog {
    ...
    private void updateAngry(Actions currentAction) {
        switch (currentAction) {
            case FEED:
            case PET:
                setState(States.HAPPY); 			//  the dog becomes happy if fed or pet
                break;
            case WALK:
                setState(States.HUNGRY); 			//  the dog becomes hungry
                break;
            
            case IGNORE:
                setState(States.ANGRY); 			// the dog stays angry
                break;
        }
    }
    ...
    private void updateSleepy(Actions currentAction) {
        switch (currentAction) {
            ...
            case PET:
            case IGNORE:
                setState(States.SLEEPY); 			//the dog stays sleepy if you pet it or ignore it
                break;
        }
    }
